...
| Composer overflow         | `apps/web/res/css/structures/_RoomView.pcss`                                                                                                                                                                                                                                                                                                                  | `width: 100%` on a column flex item is measured against the container's content box, so the composer's right margin landed past it — 2px off the window, 18px off the threads panel. `contain: strict` clips it, so that read as no gap at all                                           |
